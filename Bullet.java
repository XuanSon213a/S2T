...
public class Bullet extends Sprite {
	...
	private Gundam parent;
	private boolean destroyed = false;

	public Bullet(BufferedImage image, int frameHeight, int frameWidth, Gundam parent) {
	...
	public void setParent(Gundam t) {
		this.parent = t;
	}
	
	public Gundam getParent() {
		return this.parent;
	}
